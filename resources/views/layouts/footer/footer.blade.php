                            ...
                            <div class="collapse d-lg-block" id="collapseLanding" data-bs-parent="#ft-links">
                                <ul class="list-unstyled mb-0 py-3 py-lg-0">
                                    ...
                                    <li class="mb-2">
                                        ...
                                        <a href="mailto:contact@omiraitech.com" target="_blank" class="text-decoration-none text-reset">
                                            
                                            contact@omiraitech.com</a>
                                    </li>
                                    <li class="mb-2">
                                        ...
                                        <a href="tel:+237653092120" class="text-decoration-none text-reset">
                                            <i class="ci-support text-muted me-2"></i>(+237) 653092120
                                             </a>/
                                             <a href="tel:+237694113593" class="text-decoration-none text-reset">
                                                <i class="ci-support text-muted me-2"></i>(+237) 694113593 (WhatsApp)
                                                 </a>  
                                    </li>
                                    <li class="mb-2">
            ...
            <div class="col-md-3">
                <div class="text-md-end d-flex align-items-center justify-content-md-end">
                    ...
                    <div class="ms-3 d-flex gap-2">
                        <a href="https://web.facebook.com/omiraitech" target="_blank" class="text-reset btn btn-facebook btn-icon">
                        ...
                        <a href="https://twitter.com/Omirai10" target="_blank" class="text-reset btn btn-twitter btn-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                                <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                              </svg>
                        </a>
                        <a href="https://www.linkedin.com/company/omirai/" target="_blank" class="text-reset btn btn-linkedin btn-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                                <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854zm4.943 12.248V6.169H2.542v7.225zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248S2.4 3.226 2.4 3.934c0 .694.521 1.248 1.327 1.248zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225z"/>
                              </svg>
                        </a>
                        <a href="http://wa.me/+237694113593" target="_blank" class="text-reset btn btn-linkedin btn-icon">
