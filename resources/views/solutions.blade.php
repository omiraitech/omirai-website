        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                    <div class="text-center mb-8">
                        <h1>Utilities at hand. Endless possibilities.</h1>
                        <p class="mb-0">Extend and automate your workflow by using integrations for your favorite tools.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-12">
                    <div class="row gy-4 mb-lg-8 mb-6">
                        ...
                        <div class="col-md-4">
                            <a href="integration-single.html" class="card h-100 card-lift bg-gray-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <img src="assets/images/integration-logo/integration-logo-16.svg"
                                            alt="integration" />
                                    </div>
                                    <p class="mb-0">Receive order, billing and shipping information directly for your
                                        customers in Groove.</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="integration-single.html" class="card h-100 card-lift bg-gray-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <img src="assets/images/integration-logo/integration-logo-17.svg"
                                            alt="integration" />
                                    </div>
                                    <p class="mb-0">The Easiest Way to Deploy, Operate, and Scale MongoDB in the Cloud in
                                        Just a Few Clicks.</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="integration-single.html" class="card h-100 card-lift bg-gray-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <img src="assets/images/integration-logo/integration-logo-18.svg"
                                            alt="integration" />
                                    </div>
                                    <p class="mb-0">Make content your competitive advantage. Sanity Composable Content
                                        Cloud.</p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="row gy-4 mb-lg-8 mb-6">
                            ...
                            <a href="integration-single.html" class="card h-100 card-lift bg-gray-100">
                                <div class="card-body">
                                    <div class="icon-shape icon-xxl rounded-circle border p-3 mb-5 bg-white">
                                        <img src="assets/images/integration-logo/integrate-logo-14.svg"
                                            alt="integration" />
                                    </div>
                        ...
                        <div class="col-md-4">
                            <a href="integration-single.html" class="card h-100 card-lift bg-gray-100">
                                <div class="card-body">
                                    <div class="mb-5 icon-xxl icon-shape rounded-circle border p-3 bg-white">
                                        <img src="assets/images/integration-logo/integrate-logo-15.svg"
                                            alt="integration" />
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="icon-shape icon-lg border rounded p-3 bg-white">
                                            <img src="assets/images/integration-logo/integrate-logo-9.svg"
                                                alt="integration" />
                                        </div>
                        ...
                        <div class="col-md-4">
                            <a href="integration-single.html" class="card h-100 card-lift bg-gray-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="icon-shape icon-lg border rounded p-3 bg-white">
                                            <img src="assets/images/integration-logo/integrate-logo-4.svg"
                                                alt="integration" />
                                        </div>
                        ...
                        <div class="col-md-4">
                            <a href="integration-single.html" class="card h-100 card-lift bg-gray-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="icon-shape icon-lg border rounded p-3 bg-white">
                                            <img src="assets/images/integration-logo/integrate-logo-2.svg"
                                                alt="integration" />
                                        </div>
                    ...
                    <div class="row gy-4 mb-lg-8 mb-6" id="health">
                        <div class="col-md-12">
